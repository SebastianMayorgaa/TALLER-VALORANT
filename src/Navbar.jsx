    ...
    return (
        <nav >
            <ul className="flex justify-between items-center  px-8 text-stone-100 bg-black fixed top-0 right-0 left-0 z-50">
                ...
                <li>
                    <img className="h-[6rem]" src="https://www.citypng.com/public/uploads/preview/hd-valorant-official-logo-with-symbol-png-701751694788091hltdwppaqx.png" alt="logo-valorant" />
                </li>
                <li>
